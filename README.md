...
# 💫 About This Project:
This is an Exercise Tracker fullstack MERN App made for OSU CS290 (Web Development) Portfolio Project. The backend is a REST API with Express.js which connects to a MongoDB. The Front end is made with React/Vite.
